...
<main class="mainGalerie">
    ...
    <div class="galerie">
        ...
        <figure id="projetPrefo">
            ...
            <p>Mon premier site web réaliser en préformation, le début d'apprentissage en HTML et CSS</p>
        </figure>
        ...
        <figure id="projetLivreDor">
            ...
            <p>Livre d'or et gestion des messages, réaliser en PHP</p>
        </figure>
        ...
        <figure id="projetDublin">
            ...
            <p>Site sur la ville de Dublin, réaliser en PHP et responsive/design</p>
        </figure>
